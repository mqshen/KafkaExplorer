  ...
  <div class="schema-wrapper">
    <div class="folder-group schema"
      ...
      <a class="folder-btn"
        ...
        <i title="Schema"
           class="schema-icon item-icon material-icons">folder</i>
        <span class="table-name truncate expand"
      ...
      <div v-if="expanded">
        ...
        <template v-else>
          ...
          <div v-else
               class="list-item empty">{{placeholder || "No items"}}</div>
        </template>
      </div>
    </div>
    <div v-else>
